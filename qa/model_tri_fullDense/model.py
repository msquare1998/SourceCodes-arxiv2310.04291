...
def saveState(vec, Lx, Ly, ds, dt, Jx, Ja):
    f_r = open(f'./stateVecInfo/fullRealPart_Lx{Lx}_Ly{Ly}_ds{ds}_dt{dt}_Jx{Jx}_Ja{Ja}.dat', 'w', encoding='utf-8')
    f_i = open(f'./stateVecInfo/fullImagPart_Lx{Lx}_Ly{Ly}_ds{ds}_dt{dt}_Jx{Jx}_Ja{Ja}.dat', 'w', encoding='utf-8')
