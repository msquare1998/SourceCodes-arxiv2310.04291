...
if __name__ == "__main__":
    ...
    if plot:
        ...
        plt.plot(
            [i * ds for i in range(N)], E_list_trotterized_expm,
            color="#66CD00", linewidth=1.0, linestyle='-',
            marker="^", markersize=7, markevery=500,
            label="trotterized expm"
        )
        plt.plot(
            [i * ds for i in range(N)], E_list_trotterized_circuit,
            color="#B22222", linewidth=1.0, linestyle='-',
            marker="x", markersize=7, markevery=500,
            label="trotterized circuit"
        )
        plt.plot(
        ...
        plt.savefig("./figs/QA_comparison_nQ{}_ds{}_dt{}.eps".format(nQ, ds, dt), dpi=300)
        plt.show()