...
if __name__ == "__main__":
    ...
    if reEvolve:
        ...
        print(f"\tQA, J = {J}, K = {K}, Kp = {Kp}, ds = {ds}, dt = {dt}")
        time_0 = time()
        model.saveE_list(f"QA_J{J}_K{K}_Kp{Kp}_ds{ds}_dt{dt}", QA_sq())
        time_1 = time()
    ...
    if plot:
        ...
        plt.savefig(f"./figs/QA_J{J}_K{K}_Kp{Kp}_ds{ds}_dt{dt}.eps", dpi=300)
        plt.show()