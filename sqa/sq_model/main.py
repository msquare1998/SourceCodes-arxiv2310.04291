# ███████████████████████████████████████████████████████████████████████████████████
#       Description:
#           ◆ Sweeping QA for the square model
#       Author:
...
if __name__ == "__main__":
    ...
    if reEvolve:
        ...
        model.saveList(f"./dataList/SQA_E_list_dt{dt}_{ds}", E_list)
        model.saveList(f"./dataList/SQA_T_list_dt{dt}_{ds}", t_list)
    ...
    if plot:
        ...
        E_list = model.loadList(f"./dataList/SQA_E_list_dt{dt}_{ds}")
        t_list = model.loadList(f"./dataList/SQA_T_list_dt{dt}_{ds}")
        ...
        plt.savefig("./SQA_sq.pdf", dpi=300)
        plt.show()
